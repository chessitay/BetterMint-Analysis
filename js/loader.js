...
// Inject scripts with delay
async function injectAllScripts() {
  await injectScript("js/Mint.js");
  await wait(2500);
  await injectScript("js/analysis-common.js");
  await wait(2500);
  await injectScript("js/analysis-main.js");
  await wait(2500);
  await injectScript("js/analysis-overlay.js");
  await wait(2500);
  await injectScript("js/analysis-streamproof.js");
}
